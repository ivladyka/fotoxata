...
namespace VikkiSoft_BLL.DAL
{
	public abstract class _UserType : SqlClientEntity
	{
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllUserType]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int UserTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.UserTypeID, UserTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadUserTypeByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[UserTypeID] = _UserType.PropertyNames.UserTypeID;
					ht[Name] = _UserType.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[UserTypeID] = _UserType.ColumnNames.UserTypeID;
					ht[Name] = _UserType.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertUserType]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateUserType]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteUserType]";
