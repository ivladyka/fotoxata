...
namespace MyGeneration.dOOdads
{
	...
	{		
		...
		public bool LoadFromSql(string sp)
		{
		...
		/// </code>
		/// </example>
		public bool LoadFromSql(string sp, ListDictionary Parameters)
		{
		...
		protected bool LoadFromSql(string sp, ListDictionary Parameters, CommandType commandType)
		{
			...
			try
			{
				...
				try
				{
					commandTimeout = int.Parse(ConfigurationSettings.AppSettings["CommandTimeout"]);
				}
				catch
				{}
			...
			int commandTimeout)
		{
			...
			try
			{
				...
				try
				{
					int commandTimeoutSet = int.Parse(ConfigurationSettings.AppSettings["CommandTimeout"]);
					if(commandTimeoutSet > commandTimeout)
					{
						commandTimeout = commandTimeoutSet;
					}
				}
				catch
				{}
