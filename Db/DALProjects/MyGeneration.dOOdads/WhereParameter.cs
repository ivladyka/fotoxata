...
namespace MyGeneration.dOOdads
{
	...
	public class WhereParameter
	{
		...
		/// <param name="column"></param>
		/// <param name="param"></param>
		public WhereParameter(string column, IDataParameter param, string alias) :
			this(column, param)
		{
			this._alias = alias;
		}
		...
		/// <summary>
		/// The alias of the column in the BusinessEntity that this WhereParameter is going to query against. 
		/// </summary>
		public string Alias
		{
			get
