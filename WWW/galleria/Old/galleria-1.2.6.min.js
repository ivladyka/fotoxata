...
a + " not found")
}; Galleria.addTransition = function (a, b) { F[a] = b }; Galleria.utils = f; Galleria.log = function () { return "console" in k && "log" in k.console ? k.console.log : function () { k.alert(f.array(arguments).join(", ")) } } (); Galleria.ready = function (a) { e.each(z, function (b, d) { a.call(d, d._options) }); Galleria.ready.callbacks.push(a) }; Galleria.ready.callbacks = []; Galleria.raise = function (a, b) {
    var d = b ? "Fatal error" : "Error", c = function (a) {
        var c = '<div class="titleQuestion" style="padding:4px;margin:0 0 2px; color:red; background:#' + (b ? "811" : "fff") + '";>' + (b ?
